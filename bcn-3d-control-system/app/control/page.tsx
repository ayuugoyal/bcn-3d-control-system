...
export default function ControlPanel() {
  ...
  // Define interface for joint names
  type JointName = 'joint1' | 'joint2' | 'joint3' | 'joint4' | 'joint5' | 'gripper';

  const handleJointChange = (joint: JointName, value: number[]): void => {
    updateJointPosition(joint, value[0]);
  };

  // Handle cartesian position change
  // Define interfaces for the cartesian position components
  type CartesianComponent = 'x' | 'y' | 'z' | 'roll' | 'pitch' | 'yaw';

  const handleCartesianChange = (component: CartesianComponent, value: number): void => {
    updateCartesianPosition(component, value);
  };
