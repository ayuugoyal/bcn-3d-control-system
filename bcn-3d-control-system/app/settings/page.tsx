...
export default function Settings() {
  ...
  interface RobotSettings {
    ...
    workspaceLimit: boolean;
    collisionDetection: boolean;
    jointLimits: boolean;
  }

  const handleRobotSettingChange = <T extends keyof RobotSettings>(setting: T, value: RobotSettings[T]): void => {
  ...
  const handleNetworkSettingChange = <T extends keyof NetworkSettings>(setting: T, value: NetworkSettings[T]): void => {
